        ...
        return <div className="container-contact100">
            <div className="wrap-contact100">
                ...
                <div className="wrap-input100 validate-input" data-validate="Name is required">
                    ...
                    <input className="input100" type="text" value={this.state.firstName} onChange={this.onChange}  name="firstName" placeholder="Enter your First name"></input>
                    <span className="focus-input100" ></span>
                </div>

                    <div className="wrap-input100 validate-input" data-validate="Name is required">
                        <span className="label-input100">Your Last Name</span>
                        <input className="input100" type="text" required={true} value={this.state.LastName} onChange={this.onChange} name="LastName" placeholder="Enter your Last name"></input>
                        <span className="focus-input100"></span>
                    </div>

                    <div className="wrap-input100 validate-input" data-validate="Name is required">
                        <span className="label-input100">Your Email</span>
                        <input className="input100" type="email" required={true} name="email" placeholder="Enter your Email"></input>
                        <span className="focus-input100"></span>
                    </div>

                    <div className="wrap-input100 validate-input" data-validate="Name is required">
                        <span className="label-input100">Your Mobile No</span>
                        <input className="input100" type="number" required={true} name="mobile" placeholder="Enter your Mobile No"></input>
                        <span className="focus-input100"></span>
                    </div>

                    <div className="wrap-input100 validate-input" data-validate="Name is required">
                        <span className="label-input100">Your Date of Birth</span>
                        <input className="input100" type="date" required={true} name="date" placeholder="Enter your Date of Birth"></input>
                        <span className="focus-input100"></span>
                    </div>


                    <div className="wrap-input100 input100-select">
                        <span className="label-input100">Select your Country</span>
                        <div>
